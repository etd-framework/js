...
define(["jquery", "js/etdsolutions/text"], function($, text) {
    ...
    return {
        ...
        options: {
            ...
            itemView: null,
            listView: null,
            modalTemplate: '<div class="modal fade" id="form-modal"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">' + text._('APP_GLOBAL_CLOSE') + '</span></button><h4 class="modal-title"></h4></div><div class="modal-body"></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">' + text._('APP_GLOBAL_CLOSE') + '</button><button type="button" class="btn btn-primary">' + text._('APP_GLOBAL_OK') + '</button></div></div></div></div>',
